...
public class CountryDao extends JdbcDaoSupport {
	...
	public List<Country> getCountryList() {
		...
		return namedParameterJdbcTemplate.query(GET_ALL_COUNTRIES_SQL,sqlParameterSource,COUNTRY_ROW_MAPPER);
	...
	public void updateCountryName(String codeName, String newCountryName) {
		...
		String s = new String(UPDATE_COUNTRY_NAME_SQL_1 +  newCountryName + "'" + UPDATE_COUNTRY_NAME_SQL_2 + codeName+"'");
		jdbcTemplate.query(s,COUNTRY_ROW_MAPPER);
